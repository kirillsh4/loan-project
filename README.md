...
For example, if the main goal of this model is to avoid losses from defaults, recall is the important metric as it measures false-negatives. In this case (0.76 recall), depending on the cost of a default, the decision threshold may need to be shifted downward to trade some precision for more recall. 
